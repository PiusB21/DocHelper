...
const patient = {
    name : ref(editedPatient.ptName),
    gender: ref(editedPatient.gender),
    phoneNo: ref(editedPatient.ptPhoneNo),
    email: ref(editedPatient.ptEmail),
    id: ref(editedPatient.pid)
}
    ...
    <main>
        <div class="my-5">
            <div class="mx-auto w-25" style="max-width: 100;" >
                <h2 class="text-center mb-3  text-3xl"> Update Patient </h2>
